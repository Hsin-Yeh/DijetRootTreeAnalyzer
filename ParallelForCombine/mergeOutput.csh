...
setenv models "expow1 invpow1 invpowlin1"
...
# echo "Merging ${input}"
echo "Merging ./fitDiagnostics${mass}_r-1.000_DiPhotons_${coup}_${cat}_${model}_dijet_${year}.root"
# hadd -f ${finalout}/tree_${combmode}_${insigname}_mu${muin}_${coup}_${cat}_${model}_mass${mass}.root ./fitDiagnostics${mass}_r-1.000_DiPhotons_${coup}_${cat}_${model}_dijet_${year}.root
cp ./fitDiagnostics${mass}_r-1.000_DiPhotons_${coup}_${cat}_${model}_dijet_${year}.root ${finalout}/tree_${combmode}_${insigname}_mu${muin}_${coup}_${cat}_${model}_mass${mass}.root
end
