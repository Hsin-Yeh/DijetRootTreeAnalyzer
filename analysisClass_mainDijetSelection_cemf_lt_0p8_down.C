...
//          DeepJetBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          DeepJetBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          DeepJetBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//
//          DeepJetCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          DeepJetCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          DeepJetCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));

//          DeepCSVBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          DeepCSVBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          DeepCSVBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));

//          DeepCSVCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          DeepCSVCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          DeepCSVCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));

//          CSVv2BSFdisL->SetBinContent(tt,ttt,breader_Bloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          CSVv2BSFdisM->SetBinContent(tt,ttt,breader_Bmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));
//          CSVv2BSFdisT->SetBinContent(tt,ttt,breader_Btight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,JetEta,JetpT));

//          CSVv2CSFdisL->SetBinContent(tt,ttt,breader_Cloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          CSVv2CSFdisM->SetBinContent(tt,ttt,breader_Cmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//          CSVv2CSFdisT->SetBinContent(tt,ttt,breader_Ctight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,JetEta,JetpT));
//      }
