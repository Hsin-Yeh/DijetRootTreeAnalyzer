	 ...
	 fillVariableWithValue("CSVv2SF_l_j1",C_SF_j1_l);
         ...
         if(!isData)
         {
            //Jet 1
             if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
               {
                 J_SF_j1_l =breader_Bloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Btight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4)
               {
                 J_SF_j1_l =breader_Cloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Ctight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
             else
               {
                 J_SF_j1_l =0;
            ...
            //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               {
                 J_SF_j2_l =breader_Bloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Btight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4)
               {
                 J_SF_j2_l =breader_Cloose_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Ctight_DeepJet94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else
               {
                 J_SF_j2_l = 0;
