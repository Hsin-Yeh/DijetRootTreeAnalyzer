...
if __name__=='__main__':
  ...
  parser = OptionParser()
  parser.add_option('-l','--list',dest="li",type="string",default="none",help='root file list')
  parser.add_option('-c','--cutFile',dest='cut',type="string",default="none",help='cut file from config/')
  ...
  for i in range(split):
    ...
    ExcuteFile.write('''
cd /afs/cern.ch/work/z/zhixing/private/CMSSW_9_4_0/src/CMSDIJET/DijetRootTreeAnalyzer/
