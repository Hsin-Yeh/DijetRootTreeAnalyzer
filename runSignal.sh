...
#################### Run flags ####################
export prepare_trees_flag=false
export prepareTrees_flag=false
export addSamples_flag=false
export signalNorm_flag=true
export extractShapes_flag=false
export resonanceShapes_flag=false

########## Prepare trees ##########
if $prepareTrees_flag; then
