...
if $combineCard_flag; then
    ...
    do
        ...
        do
            echo ${scenario}
            for mass in `seq 500 ${massInterval} 7000`
            do echo ${mass}
               combineCards.py ${datacardsDir}/${method}/${year}/${scenario}_EBEB/diphoton_combine_${mass}_${scenario}_EBEB_${year}.txt    ${datacardsDir}/${method}/${year}/${scenario}_EBEE/diphoton_combine_${mass}_${scenario}_EBEE_${year}.txt  > diphoton_combine_${mass}_${scenario}_${year}.txt
            done
        done
    done
    ...
    do
        ...
        do
            echo ${mass}
            combineCards.py ${datacardsDir}/${method}/2016/${scenario}_EBEB/diphoton_combine_${mass}_${scenario}_EBEB_2016.txt ${datacardsDir}/${method}/2016/${scenario}_EBEE/diphoton_combine_${mass}_${scenario}_EBEE_2016.txt ${datacardsDir}/${method}/2017/${scenario}_EBEB/diphoton_combine_${mass}_${scenario}_EBEB_2017.txt ${datacardsDir}/${method}/2017/${scenario}_EBEE/diphoton_combine_${mass}_${scenario}_EBEE_2017.txt ${datacardsDir}/${method}/2018/${scenario}_EBEB/diphoton_combine_${mass}_${scenario}_EBEB_2018.txt ${datacardsDir}/${method}/2018/${scenario}_EBEE/diphoton_combine_${mass}_${scenario}_EBEE_2018.txt > diphoton_combine_${mass}_${scenario}.txt;
        done
    done
fi
