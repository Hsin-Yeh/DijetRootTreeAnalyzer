...
csv_list = [0.0614,0.1,0.15,0.2, 0.2217,0.25, 0.3093,0.35,0.4,0.45,0.5, 0.5426,0.6, 0.6321, 0.7221,0.8, 0.8484, 0.8953, 0.9535] 
...
c1.SetGridy()
c1.cd()
g_le1btag_rate_Q['L'] = gr['DeepJet']['le1'][0.0614] 
g_le1btag_rate_Q['M'] = gr['DeepJet']['le1'][0.3093]
g_le1btag_rate_Q['T'] = gr['DeepJet']['le1'][0.7221]
