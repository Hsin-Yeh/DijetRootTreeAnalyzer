...
export SigNormFile="/afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/SignalNorm_Splines_${method}.txt"
...
for coup in {"kMpl001","kMpl01","kMpl02"}; do
    for cat in {"EBEB","EBEE"}; do
        for mass in `seq 650 ${massInterval} 5000`; do
            for fitmethod in {"expow1","invpow1","invpowlin1","dijet","envelope"}; do
                mkdir -p output/envelope/${year}/${model}/${coup}/${cat}
...
# themainpath="/afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/CMSDIJET/DijetRootTreeAnalyzer/output/envelope"
# for year in {2016,2017,2018}
# do
#     echo ${year}
#     cd ${themainpath}/${method}/${year}
#     for scenario in {"DiPhotons_kMpl001","DiPhotons_kMpl01","DiPhotons_kMpl02"}
#     do
#         echo ${scenario}
#         for mass in `seq 500 ${massInterval} 7000`
#         do echo ${mass}
#            combineCards.py ${themainpath}/${year}/${model}/${coup}/${cat}/diphoton_combine_${mass}_${scenario}_EBEB_${year}.txt    ${themainpath}/${method}/${year}/${scenario}_EBEE/diphoton_combine_${mass}_${scenario}_EBEE_${year}.txt  > diphoton_combine_${mass}_${scenario}_${year}.txt
#         done
#     done
# done
