...
if __name__ == "__main__":
    ...
    MC_masses["kMpl001"] = array('d',[750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 2750, 3000, 3250, 3500, 4000, 5000])
    MC_masses["kMpl01"] = array('d',[750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 3000, 3500, 4000, 4250, 4500, 4750, 5000, 5250, 5500, 5750, 6000, 6500, 7000, 8000])
    MC_masses["kMpl02"] = array('d',[750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 3000, 3500, 4000, 4500, 4750, 5000, 5250, 5500, 5750, 6000, 6500, 7000, 8000])

    MC_crossSections["kMpl001"] = array('d',[4.850e-02, 1.133e-02, 3.428e-03, 1.234e-03, 4.981e-04, 2.201e-04, 1.036e-04, 5.074e-05, 2.613e-05, 1.384e-05, 7.548e-06, 4.226e-06, 1.439e-06, 2.150e-07])
    ...
    MC_crossSection_fb = array('d',np.multiply(MC_crossSections[args.coupling],1000))
    g_xs = ROOT.TGraph(len(MC_masses[args.coupling]),MC_masses[args.coupling],MC_crossSection_fb)
