...
combine_parameters = ['Ntot_bkg_BOXNAME[1.e+04]',
                   'p0_BOXNAME[1]',
                'p1_BOXNAME[-14]',
                'p2_BOXNAME[13]',
                'p3_BOXNAME[1.2]',
...
combine_pdfs = ['RooDijet5ParamBinPdf::BOXNAME_bkg(th1x,p1_BOXNAME,p2_BOXNAME,p3_BOXNAME,p4_BOXNAME,sqrts)',
                "EXPR::BOXNAME_bkg_unbin('p0_BOXNAME*(pow(1-mjj/sqrts,p1_BOXNAME)/pow(mjj/sqrts,p2_BOXNAME+p3_BOXNAME*log(mjj/sqrts)+p4_BOXNAME*log(mjj/sqrts)*log(mjj/sqrts)))',mjj,p0_BOXNAME,p1_BOXNAME,p2_BOXNAME,p3_BOXNAME,p4_BOXNAME,sqrts)",
...
if __name__=='__main__':
    ...
    Edit_Config('config/dijet_5param.config',box,histoN)
