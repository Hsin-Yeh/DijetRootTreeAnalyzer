...
if __name__ == '__main__':
    ...
    legsig = rt.TLegend(0.21,0.12,0.4,0.35)
    ...
    EBText=rt.TLatex(0.3,0.83, "%s"%(options.cat));
    EBText.SetNDC(1);
    ...
    legres_data = rt.TLegend(0.69,0.48,0.94,0.55)
    ...
    legres_data.Draw()
    legres_sig = rt.TLegend(0.54,0.29,0.88,0.47)
    legres_sig.SetTextFont(42)
    legres_sig.SetTextSize(0.075)
