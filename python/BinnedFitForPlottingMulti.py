...
def addSignalHisto(h_bkg,data_obs_TGraph_,N_massBins_,massBins_,cat,lumi):
    ...
    sighist_2200.SetFillColorAlpha(rt.kViolet,0.9)
    ...
    h_residual_2200.SetFillColorAlpha(rt.kViolet,0.9)
