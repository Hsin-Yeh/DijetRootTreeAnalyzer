...
if __name__ == '__main__':
    ...
    legres = rt.TLegend(0.6,0.2,0.88,0.4)
    ...
    legres.AddEntry(h_fit_residual_vs_mass,"(Data-Fit)/Uncertainty","f")
    legres.AddEntry(h_residual_1320,"Signal/Uncertainty (M_{G}=1.3 TeV)","f")
    legres.AddEntry(h_residual_2200,"Signal/Uncertainty (M_{G}=2.2 TeV)","f")
    legres.Draw()
