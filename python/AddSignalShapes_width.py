...
if __name__ == '__main__':
    ...
    for f in args:
        ...
        h_mgg_ratio.SetName('h_%s_%s_%s'%(title,coup,year))
        h_mgg_ratio.SetTitle('h_%s_%s_%s'%(title,coup,year))
        h_mgg_ratio.SetDirectory(0)
        histos.append(h_mgg_ratio)
        h_mgg_8GeVbin.SetName('h_%s_%s_%s_8Gev'%(title,coup,year))
        h_mgg_8GeVbin.SetTitle('h_%s_%s_%s_8GeV'%(title,coup,year))
