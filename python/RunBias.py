...
if __name__ == '__main__':
    ...
    if 'DiPhotons' in box:
        if 'kMpl' in box: 
            signalDsName = '/afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s.root'% (box.split("_")[-2], box.split("_")[-1], options.year)
        else: 
            signalDsName = '/afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s.root'% (box.split("_")[-2], box.split("_")[-1], options.year)
    ...
    if 'DiPhotons' in box:
        if 'kMpl' in box: 
            signalSys  =   '--eneScStatUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleStatUp.root --eneScStatDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleStatDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScSystUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleSystUp.root --eneScSystDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleSystDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScGainUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleGainUp.root --eneScGainDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energyScaleGainDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScSigmaUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energySigmaUp.root --eneScSigmaDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_RSGravitonToGammaGamma_%s_%s_%s_energySigmaDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
        else: 
            signalSys  =   '--eneScStatUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleStatUp.root --eneScStatDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleStatDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScSystUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleSystUp.root --eneScSystDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleSystDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScGainUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleGainUp.root --eneScGainDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energyScaleGainDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
            signalSys  +=   ' --eneScSigmaUp /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energySigmaUp.root --eneScSigmaDown /afs/cern.ch/work/h/hsinyeh/public/diphoton-analysis/CMSSW_10_2_13/src/diphoton-analysis/DijetShapeInterpolator/ResonanceShapes_InputShapes_GluGluSpin0ToGammaGamma_W_%s_%s_%s_energySigmaDown.root'% (box.split("_")[-2], box.split("_")[-1], options.year, box.split("_")[-2], box.split("_")[-1], options.year)
