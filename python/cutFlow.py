...
if __name__ == "__main__":
    ...
    for in_filename in args.in_filenames:
        ...
        h_pt125=ROOT.TH1F("h_pt125",1,0,2)
        h_photonID=ROOT.TH1F("h_photonID",1,0,2)
        h_eta=ROOT.TH1F("h_eta",1,0,2)
        h_mass = ROOT.TH1F("h_mass","h_mass",1,0,2)
        h_deltaR = ROOT.TH1F("h_deltaR","h_deltaR",1,0,2)
        h_HLT = ROOT.TH1F("h_HLT","h_HLT",1,0,2)

        project(fTree,h_pt125,"1","Photon1.pt>125 && Photon2.pt>125")
        project(fTree,h_photonID,"1","isGood*(Photon1.pt>125 && Photon2.pt>125)")
