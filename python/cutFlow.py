...
if __name__ == "__main__":
    ...
    for in_filename in args.in_filenames:
        ...
        project(fTree,h_mass,"1","isGood*(Photon1.pt>125 && Photon2.pt>125)*((Diphoton.Minv > 500 && Diphoton.isEBEB)||(Diphoton.Minv > 500 && Diphoton.isEBEE)||(Diphoton.Minv > 300 && Diphoton.isEEEB))")
        project(fTree,h_deltaR,"1","isGood*(Photon1.pt>125 && Photon2.pt>125)*((Diphoton.Minv > 500 && Diphoton.isEBEB)||(Diphoton.Minv > 500 && Diphoton.isEBEE)||(Diphoton.Minv > 500 && Diphoton.isEEEB))*(Diphoton.deltaR > 0.45)")
        project(fTree,h_HLT,"1","isGood*(Photon1.pt>125 && Photon2.pt>125)*((Diphoton.Minv > 500 && Diphoton.isEBEB)||(Diphoton.Minv > 500 && Diphoton.isEBEE)||(Diphoton.Minv > 500 && Diphoton.isEEEB))*(Diphoton.deltaR > 0.45)*(HLT_DoublePhoton70>0 || HLT_ECALHT800>0)")
