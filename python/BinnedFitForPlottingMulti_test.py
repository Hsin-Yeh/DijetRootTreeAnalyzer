...
from WriteDataCard_test import initializeWorkspace,convertToTh1xHist,convertToMjjHist,applyTurnonFunc,applyTurnonGraph
import os
import random
import sys
import math
...
if __name__ == '__main__':
    ...
    l.SetNDC()
    #l.DrawLatex(0.7,0.96,"%i pb^{-1} (%i TeV)"%(lumi,w.var('sqrts').getVal()/1000.))
    l.DrawLatex(0.64,0.94,"%.2f fb^{-1} (13 TeV)"%(lumi/1000.))
    # PAS
    #l.SetTextFont(62)
    #l.SetTextSize(0.055)
