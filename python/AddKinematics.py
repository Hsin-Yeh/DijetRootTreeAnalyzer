...
if __name__ == '__main__':
    ...
    for f in args:
        ...
        h_deltaPhi = rt.TH1D('h_deltaPhi','h_deltaPhi',10,0,4)
        h_ph1pt    = rt.TH1D('h_ph1pt','h_ph1pt',20,0,1000)
        h_ph1scEta = rt.TH1D('h_ph1scEta','h_ph1scEta',10,-2.,2.)
        h_ph2pt    = rt.TH1D('h_ph2pt'   ,'h_ph2pt',20,0,1000)
        h_ph2scEta = rt.TH1D('h_ph2scEta','h_ph2scEta',10,-2.,2.)
