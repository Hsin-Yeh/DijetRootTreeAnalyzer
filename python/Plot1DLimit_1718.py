...
def getThyXsecDict():    
    thyXsecDict = {}
    xsecFiles = ['data/all_lowmass_lhc13TeV.txt','data/rsg_gg_lhc13TeV.txt','data/S8_13TeV_narrow.txt','data/string_total_13TeV.txt','data/axi_lhc13TeV_NLO.txt','data/dm_xsec.txt','data/Zprimebb_xsec.txt','data/dmbb_xsec.txt','data/bstar_deta1p1_lhc13TeV.txt','data/axi_bb_univ_deta1p1_lhc13TeV_NLO.txt']
    ...
    for (mass,thyXsec) in thyXsecDict['b*'].iteritems():
         thyXsecDict['b*'][mass] = thyXsec
