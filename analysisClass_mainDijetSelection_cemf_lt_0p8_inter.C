  ...
  :baseClass(inputList, cutFile, treeName, outputFileName, cutEfficFile)
{
 ...
 std::string L1DATAPath = "data/Spring16_25nsV6_DATA/Spring16_25nsV6_DATA_L1FastJet_AK4PFchs.txt";
   ...
   unc = new JetCorrectionUncertainty("data/Fall17_17Nov2017_V32_MC/Fall17_17Nov2017_V32_MC_Uncertainty_AK4PFchs.txt");
  ...
  bcalib94XDeepCSV = new BTagCalibration("DeepCSV", "data/bTag_MC_ScalingFactors/DeepCSV_94XSF_V2_B_F.csv");
  bcalib94XDeepJet = new BTagCalibration("DeepJet", "data/bTag_MC_ScalingFactors/DeepFlavour_94XSF_V1_B_F.csv");
...
void analysisClass::Loop()
{
   ...
   TH2D *DeepJetBSFdisL = new TH2D("SFDeepJetBdisL","SFDeepJetBdisL",200,0,1000,100,-3.14,3.14);
   TH2D *DeepJetBSFdisM = new TH2D("SFDeepJetBdisM","SFDeepJetBdisM",200,0,1000,100,-3.14,3.14);
   TH2D *DeepJetBSFdisT = new TH2D("SFDeepJetBdisT","SFDeepJetBdisT",200,0,1000,100,-3.14,3.14);

   TH2D *DeepJetCSFdisL = new TH2D("SFDeepJetCdisL","SFDeepJetCdisL",200,0,1000,100,-3.14,3.14);
   TH2D *DeepJetCSFdisM = new TH2D("SFDeepJetCdisM","SFDeepJetCdisM",200,0,1000,100,-3.14,3.14);
   TH2D *DeepJetCSFdisT = new TH2D("SFDeepJetCdisT","SFDeepJetCdisT",200,0,1000,100,-3.14,3.14);

   TH2D *DeepCSVBSFdisL = new TH2D("SFDeepCSVBdisL","SFDeepCSVBdisL",200,0,1000,100,-3.14,3.14);
   TH2D *DeepCSVBSFdisM = new TH2D("SFDeepCSVBdisM","SFDeepCSVBdisM",200,0,1000,100,-3.14,3.14);
   TH2D *DeepCSVBSFdisT = new TH2D("SFDeepCSVBdisT","SFDeepCSVBdisT",200,0,1000,100,-3.14,3.14);

   TH2D *DeepCSVCSFdisL = new TH2D("SFDeepCSVCdisL","SFDeepCSVCdisL",200,0,1000,100,-3.14,3.14);
   TH2D *DeepCSVCSFdisM = new TH2D("SFDeepCSVCdisM","SFDeepCSVCdisM",200,0,1000,100,-3.14,3.14);
   TH2D *DeepCSVCSFdisT = new TH2D("SFDeepCSVCdisT","SFDeepCSVCdisT",200,0,1000,100,-3.14,3.14);

   TH2D *CSVv2BSFdisL = new TH2D("SFCSVv2BdisL","SFCSVv2BdisL",200,0,1000,100,-3.14,3.14);
   TH2D *CSVv2BSFdisM = new TH2D("SFCSVv2BdisM","SFCSVv2BdisM",200,0,1000,100,-3.14,3.14);
   TH2D *CSVv2BSFdisT = new TH2D("SFCSVv2BdisT","SFCSVv2BdisT",200,0,1000,100,-3.14,3.14);

   TH2D *CSVv2CSFdisL = new TH2D("SFCSVv2CdisL","SFCSVv2CdisL",200,0,1000,100,-3.14,3.14);
   TH2D *CSVv2CSFdisM = new TH2D("SFCSVv2CdisM","SFCSVv2CdisM",200,0,1000,100,-3.14,3.14);
   TH2D *CSVv2CSFdisT = new TH2D("SFCSVv2CdisT","SFCSVv2CdisT",200,0,1000,100,-3.14,3.14);
