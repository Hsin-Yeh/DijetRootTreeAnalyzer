  ...
  :baseClass(inputList, cutFile, treeName, outputFileName, cutEfficFile)
{
  ...
  /*
    ...
    iov = new jec::IOV("AK4PFchs");
    iov->add("A",315252,316995,true);
    iov->add("B",317080,319077,true);
    iov->add("C",319337,320065,true);
    iov->add("D",320673,325175,true);   
  ...
  /*  std::string L1DATAPath = "data/2017MC/Fall17_17Nov2017_V4_DATA_L1FastJet_AK4PFchs.txt";
    ...
    std::string L1Path = "data/Autumn18_V8_MC/Autumn18_V8_MC_L1FastJet_AK4PFchs.txt";
    std::string L2Path = "data/Autumn18_V8_MC/Autumn18_V8_MC_L2Relative_AK4PFchs.txt";
    std::string L3Path = "data/Autumn18_V8_MC/Autumn18_V8_MC_L3Absolute_AK4PFchs.txt";



   std::string L1DATAPath = "data/Autumn18_V8_DATA/Autumn18_RunA_V8_DATA_L1FastJet_AK4PFchs.txt";
    std::string L2DATAPath = "data/Autumn18_V8_DATA/Autumn18_RunA_V8_DATA_L2Relative_AK4PFchs.txt";
    std::string L3DATAPath = "data/Autumn18_V8_DATA/Autumn18_RunA_V8_DATA_L3Absolute_AK4PFchs.txt";
    std::string L2L3ResidualPath = "data/Autumn18_V8_DATA/Autumn18_RunA_V8_DATA_L2L3Residual_AK4PFchs.txt";

  unc = new JetCorrectionUncertainty("data/Autumn18_V8_MC/Autumn18_V8_MC_Uncertainty_AK4PFchs.txt");
  ...
  bcalib94XCSVv2   = new BTagCalibration("CSVv2"  , "data/bTag_MC_ScalingFactors/CSVv2_94XSF_V2_B_F.csv");
  bcalib94XDeepCSV = new BTagCalibration("DeepCSV", "data/bTag_MC_ScalingFactors/DeepCSV_102XSF_WP_V1.csv");
  bcalib94XDeepJet = new BTagCalibration("DeepJet", "data/bTag_MC_ScalingFactors/DeepJet_102XSF_WP_V1.csv");
  ...
  breader_Bloose_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  breader_Bloose_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Cloose_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  ...
  breader_Bmedium_DeepJet94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  breader_Bmedium_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_DeepJet94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  ...
  breader_Btight_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
  breader_Btight_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Ctight_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
...
void analysisClass::Loop()
{
 ...
 char* HLTname[50]    = {"noTrig","PFHT1050","PFJet550","Mu50","CaloJet550","AllJet","PFHT1050_not_OR_from_others","PFJet550_not_OR_from_others","CaloJet550_not_OR_from_others","PFHT1050_OR_PFJet550","PFHT1050_OR_CaloJet550"};
...
h_CEMF_test2->Fill(jetCemfAK4->at(sortedJetIdx[1]));
	 ...
	 fillVariableWithValue("CSVv2SF_l_j1",C_SF_j1_l);
         ...
         {  
            //Jet 1
             if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
               { 
                 J_SF_j1_l =breader_Bloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Btight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4)
               { 
                 J_SF_j1_l =breader_Cloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Ctight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
             else
               { 
                 J_SF_j1_l =0;
            ...
            //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               { 
                 J_SF_j2_l =breader_Bloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Btight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4)
               { 
                 J_SF_j2_l =breader_Cloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Ctight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else
               { 
                 J_SF_j2_l = 0;
	...
	for (int ttt=0;ttt<100;ttt++){
	  ...
	  DeepJetBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepJetBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepJetBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));

          DeepJetCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepJetCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepJetCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepJet94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));

          DeepCSVBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepCSVBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepCSVBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));

          DeepCSVCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepCSVCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepCSVCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));

          CSVv2BSFdisL->SetBinContent(tt,ttt,breader_Bloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          CSVv2BSFdisM->SetBinContent(tt,ttt,breader_Bmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));
          CSVv2BSFdisT->SetBinContent(tt,ttt,breader_Btight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,JetEta,JetpT));

          CSVv2CSFdisL->SetBinContent(tt,ttt,breader_Cloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          CSVv2CSFdisM->SetBinContent(tt,ttt,breader_Cmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
          CSVv2CSFdisT->SetBinContent(tt,ttt,breader_Ctight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,JetEta,JetpT));
