...
*/    
  ...
  /*  std::string L1DATAPath = "data/2017MC/Fall17_17Nov2017_V4_DATA_L1FastJet_AK4PFchs.txt";
    ...
    std::string L1Path = "data/Summer16_07Aug2017_V11_MC/Summer16_07Aug2017_V11_MC_L1FastJet_AK4PFchs.txt";
    std::string L2Path = "data/Summer16_07Aug2017_V11_MC/Summer16_07Aug2017_V11_MC_L2Relative_AK4PFchs.txt";
    std::string L3Path = "data/Summer16_07Aug2017_V11_MC/Summer16_07Aug2017_V11_MC_L3Absolute_AK4PFchs.txt";
...
unc = new JetCorrectionUncertainty("data/Summer16_07Aug2017_V11_MC/Summer16_07Aug2017_V11_MC_Uncertainty_AK4PFchs.txt");
  ...
  bcalib94XCSVv2   = new BTagCalibration("CSVv2"  , "data/bTag_MC_ScalingFactors/CSVv2_Moriond17_B_H.csv");
  bcalib94XDeepCSV = new BTagCalibration("DeepCSV", "data/bTag_MC_ScalingFactors/DeepCSV_2016LegacySF_WP_V1.csv");
  bcalib94XDeepJet = new BTagCalibration("DeepJet", "data/bTag_MC_ScalingFactors/DeepJet_2016LegacySF_WP_V1.csv");

  //loose WP
  breader_Bloose_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Bloose_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Cloose_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Cloose_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Bloose_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Bloose_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Cloose_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Cloose_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");
  breader_Bloose_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Bloose_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Cloose_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"up", {"up", "down"});
  breader_Cloose_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_C,"comb");

 
   //medium WP
  breader_Bmedium_CSVv294X   = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Bmedium_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_CSVv294X   = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Cmedium_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Bmedium_DeepCSV94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Bmedium_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_DeepCSV94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Cmedium_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");
  breader_Bmedium_DeepJet94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Bmedium_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_DeepJet94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"up", {"up", "down"});
  breader_Cmedium_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_C,"comb");


  //tight WP
  breader_Btight_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Btight_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Ctight_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Ctight_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Btight_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Btight_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Ctight_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Ctight_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");
  breader_Btight_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Btight_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_B,"comb");
  breader_Ctight_DeepJet94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"up", {"up", "down"});
  breader_Ctight_DeepJet94X->load(*bcalib94XDeepJet, BTagEntry::FLAV_C,"comb");
...
void analysisClass::Loop()
{
   ...
   TH2D *DeepJetBSFdisL = new TH2D("SFDeepJetBdisL","SFDeepJetBdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepJetBSFdisM = new TH2D("SFDeepJetBdisM","SFDeepJetBdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepJetBSFdisT = new TH2D("SFDeepJetBdisT","SFDeepJetBdisT",1000,0,5000,100,-3.14,3.14);

   TH2D *DeepJetCSFdisL = new TH2D("SFDeepJetCdisL","SFDeepJetCdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepJetCSFdisM = new TH2D("SFDeepJetCdisM","SFDeepJetCdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepJetCSFdisT = new TH2D("SFDeepJetCdisT","SFDeepJetCdisT",1000,0,5000,100,-3.14,3.14);

   TH2D *DeepCSVBSFdisL = new TH2D("SFDeepCSVBdisL","SFDeepCSVBdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepCSVBSFdisM = new TH2D("SFDeepCSVBdisM","SFDeepCSVBdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepCSVBSFdisT = new TH2D("SFDeepCSVBdisT","SFDeepCSVBdisT",1000,0,5000,100,-3.14,3.14);

   TH2D *DeepCSVCSFdisL = new TH2D("SFDeepCSVCdisL","SFDeepCSVCdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepCSVCSFdisM = new TH2D("SFDeepCSVCdisM","SFDeepCSVCdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *DeepCSVCSFdisT = new TH2D("SFDeepCSVCdisT","SFDeepCSVCdisT",1000,0,5000,100,-3.14,3.14);

   TH2D *CSVv2BSFdisL = new TH2D("SFCSVv2BdisL","SFCSVv2BdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *CSVv2BSFdisM = new TH2D("SFCSVv2BdisM","SFCSVv2BdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *CSVv2BSFdisT = new TH2D("SFCSVv2BdisT","SFCSVv2BdisT",1000,0,5000,100,-3.14,3.14);

   TH2D *CSVv2CSFdisL = new TH2D("SFCSVv2CdisL","SFCSVv2CdisL",1000,0,5000,100,-3.14,3.14);
   TH2D *CSVv2CSFdisM = new TH2D("SFCSVv2CdisM","SFCSVv2CdisM",1000,0,5000,100,-3.14,3.14);
   TH2D *CSVv2CSFdisT = new TH2D("SFCSVv2CdisT","SFCSVv2CdisT",1000,0,5000,100,-3.14,3.14);
...
//cout << correction << endl;
     ...
     if( AK4jets.size() >=1 ){
       ...
       fillVariableWithValue( "jetDeepJetAK4_j1", jetDeepJetAK4->at(sortedJetIdx[0]) );
     ...
     if( AK4jets.size() >=2 ){
       ...
       fillVariableWithValue( "jetDeepJetAK4_j2", jetDeepJetAK4->at(sortedJetIdx[1]) );
	 ...
	 fillVariableWithValue("CSVv2SF_l_j1",C_SF_j1_l);
         ...
         if(!isData)
         {
            //Jet 1
             if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
               {
                 J_SF_j1_l =breader_Bloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Btight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4)
               {
                 J_SF_j1_l =breader_Cloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 J_SF_j1_t =breader_Ctight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
             else
               {
                 J_SF_j1_l =0;
            ...
            //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               {
                 J_SF_j2_l =breader_Bloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Bmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Btight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4)
               {
                 J_SF_j2_l =breader_Cloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_m =breader_Cmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 J_SF_j2_t =breader_Ctight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else
               {
                 J_SF_j2_l = 0;
         ...
         fillVariableWithValue("DeepJetSF_l_j1",J_SF_j1_l);
         fillVariableWithValue("DeepJetSF_m_j1",J_SF_j1_m);
         fillVariableWithValue("DeepJetSF_t_j1",J_SF_j1_t);

         fillVariableWithValue("DeepJetSF_l_j2",J_SF_j2_l);
         fillVariableWithValue("DeepJetSF_m_j2",J_SF_j2_m);
         fillVariableWithValue("DeepJetSF_t_j2",J_SF_j2_t);
...
/*
     for (int tt=0;tt<1000;tt++)
        for (int ttt=0;ttt<100;ttt++){
          ...
          double JetpT = 2.5+tt*5;
          double JetEta= -3.14+ttt*0.0628+0.0314;

          DeepJetBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepJetBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepJetBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));

          DeepJetCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepJetCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepJetCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepJet94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));

          DeepCSVBSFdisL->SetBinContent(tt,ttt,breader_Bloose_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepCSVBSFdisM->SetBinContent(tt,ttt,breader_Bmedium_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          DeepCSVBSFdisT->SetBinContent(tt,ttt,breader_Btight_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));

          DeepCSVCSFdisL->SetBinContent(tt,ttt,breader_Cloose_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepCSVCSFdisM->SetBinContent(tt,ttt,breader_Cmedium_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          DeepCSVCSFdisT->SetBinContent(tt,ttt,breader_Ctight_DeepCSV94X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));

          CSVv2BSFdisL->SetBinContent(tt,ttt,breader_Bloose_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          CSVv2BSFdisM->SetBinContent(tt,ttt,breader_Bmedium_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));
          CSVv2BSFdisT->SetBinContent(tt,ttt,breader_Btight_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_B,JetEta,JetpT));

          CSVv2CSFdisL->SetBinContent(tt,ttt,breader_Cloose_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          CSVv2CSFdisM->SetBinContent(tt,ttt,breader_Cmedium_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
          CSVv2CSFdisT->SetBinContent(tt,ttt,breader_Ctight_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_C,JetEta,JetpT));
      }
*/
...
DeepCSVBSFdisL->Write();
DeepCSVBSFdisM->Write();
DeepCSVBSFdisT->Write();

DeepJetBSFdisL->Write();
DeepJetBSFdisM->Write();
DeepJetBSFdisT->Write();

CSVv2CSFdisL->Write();
CSVv2CSFdisM->Write();
CSVv2CSFdisT->Write();

DeepCSVCSFdisL->Write();
DeepCSVCSFdisM->Write();
DeepCSVCSFdisT->Write();

DeepJetCSFdisL->Write();
DeepJetCSFdisM->Write();
DeepJetCSFdisT->Write();
   // h_nVtx->Write();
   // h_trueVtx->Write();
   // h_nJetFinal->Write();
   // h_pT1stJet->Write();
